...
import 'package:project/controllers/glasses_provider.dart';
...
class _GlassesScreenState extends State<GlassesScreen> {
  ...
  Future<void> fetch() async {
    await Provider.of<GlassesProvider>(context, listen: false)
        .getProviderGlasses();


    setState(() {
      glasses_list =
          Provider.of<GlassesProvider>(context, listen: false).glist;
    });
  }
                ...
                return InkWell(
                  onTap: () {
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                GlassesDetail(c: glasses_list[index])));
                  },
                  child: Card(
                    child: Column(
                      children: <Widget>[
                        Center(
                            child: SizedBox(
                              width: 1200,
                              height: 295,
                              child: Image.network(glasses_list[index].image ??
                        ...
                        Text(glasses_list[index].name,
                            style: TextStyle(fontSize: 12)),
                        const SizedBox(
                          height: 7,
                        ),
                        Text(
                          glasses_list[index].price.toString(),
                          style: TextStyle(
